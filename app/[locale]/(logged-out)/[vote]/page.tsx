      ...
      <>
        ...
        <div className="min-h-screen bg-gray-50 p-4 py-8">
          ...
          <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 mb-6">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-5 gap-3">
              <button 
                ...
                className="h-12 bg-black hover:bg-gray-800 text-white flex items-center justify-center gap-1 sm:gap-2 rounded-lg font-medium transition-all duration-200 hover:scale-105 text-xs sm:text-sm cursor-pointer"
              >
              ...
              <button 
                ...
                className="h-12 bg-blue-600 hover:bg-blue-700 text-white flex items-center justify-center gap-1 sm:gap-2 rounded-lg font-medium transition-all duration-200 hover:scale-105 text-xs sm:text-sm cursor-pointer"
              >
                <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <button 
                ...
                className="h-12 bg-green-500 hover:bg-green-600 text-white flex items-center justify-center gap-1 sm:gap-2 rounded-lg font-medium transition-all duration-200 hover:scale-105 text-xs sm:text-sm cursor-pointer"
              >
                <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <button 
                ...
                className="h-12 bg-blue-500 hover:bg-blue-600 text-white flex items-center justify-center gap-1 sm:gap-2 rounded-lg font-medium transition-all duration-200 hover:scale-105 text-xs sm:text-sm cursor-pointer"
              >
                <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* Copy Link Button - Full width on mobile, equal width on desktop */}
              <button 
                onClick={async () => {
                  try {
                ...
                className="h-12 bg-gray-600 hover:bg-gray-700 text-white flex items-center justify-center gap-1 sm:gap-2 rounded-lg font-medium transition-all duration-200 hover:scale-105 text-xs sm:text-sm cursor-pointer"
              >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
            <button
              onClick={() => router.push('/')}
              className="px-8 py-3 bg-orange-500 text-white rounded-lg hover:bg-orange-600 transition-colors font-medium cursor-pointer"
            >
              {t('backToHome')}
            </button>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 py-4">
          ...
          {currentPair?.map((option) => (
            <button
              ...
              className={`group relative bg-white rounded-2xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-2xl hover:scale-105 cursor-pointer ${
