          ...
          <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
            ...
            <div className="grid grid-cols-5 gap-3">
              <button 
                ...
                className="h-12 bg-black hover:bg-gray-800 text-white flex items-center justify-center gap-2 rounded-lg font-medium transition-all duration-200 hover:scale-105"
              >
              ...
              <button 
                ...
                className="h-12 bg-blue-600 hover:bg-blue-700 text-white flex items-center justify-center gap-2 rounded-lg font-medium transition-all duration-200 hover:scale-105"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <button 
                ...
                className="h-12 bg-green-500 hover:bg-green-600 text-white flex items-center justify-center gap-2 rounded-lg font-medium transition-all duration-200 hover:scale-105"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <button 
                ...
                className="h-12 bg-blue-500 hover:bg-blue-600 text-white flex items-center justify-center gap-2 rounded-lg font-medium transition-all duration-200 hover:scale-105"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <button 
                ...
                className="h-12 bg-gray-600 hover:bg-gray-700 text-white flex items-center justify-center gap-2 rounded-lg font-medium transition-all duration-200 hover:scale-105"
              >
