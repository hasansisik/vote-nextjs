          ...
          <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 mb-6">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-5 gap-3">
              ...
              <button 
                ...
                className="h-12 bg-gray-600 hover:bg-gray-700 text-white flex items-center justify-center gap-1 sm:gap-2 rounded-lg font-medium transition-all duration-200 hover:scale-105 text-xs sm:text-sm"
              >
